...
spool "migrationRepo_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_migrationRepo ...
DROP ROLE ROLE_migrationRepo ;
PROMPT Creating Role ROLE_migrationRepo ...
CREATE ROLE ROLE_migrationRepo ;

-- PROMPT Drop lab10 user
-- drop user lab10 cascade;
   
PROMPT Create user lab10
...
PROMPT Creating Primary Key Constraint PK__Users__1788CCACE8B8A026 on table Users ... 
ALTER TABLE Users
ADD CONSTRAINT PK__Users__1788CCACE8B8A026 PRIMARY KEY
(
  UserID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Users__A9D1053459303713 on table Users
ALTER TABLE Users
ADD CONSTRAINT UQ__Users__A9D1053459303713 UNIQUE (
  Email
)
ENABLE
;
...
PROMPT Creating Primary Key Constraint PK__Orders__C3905BAFA02D597F on table Orders ... 
ALTER TABLE Orders
ADD CONSTRAINT PK__Orders__C3905BAFA02D597F PRIMARY KEY
(
  OrderID
)
ENABLE
...
alter session set current_schema=lab10;
set define off
PROMPT Creating Foreign Key Constraint FK__Orders__UserID__49C3F6B7 on table Users...
ALTER TABLE Orders
ADD CONSTRAINT FK__Orders__UserID__49C3F6B7 FOREIGN KEY
(
  UserID
)
REFERENCES Users
